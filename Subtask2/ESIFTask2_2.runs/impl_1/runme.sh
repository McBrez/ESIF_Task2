...
HD_PWD='D:/DEV/ESIF/Task2/ESIF_Task2/Subtask2/ESIFTask2_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ESIFTask2_2_bd_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ESIFTask2_2_bd_wrapper.tcl -notrace
