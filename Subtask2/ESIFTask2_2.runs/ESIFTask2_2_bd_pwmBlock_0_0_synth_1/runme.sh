...
HD_PWD='D:/DEV/ESIF/Task2/ESIF_Task2/Subtask2/ESIFTask2_2.runs/ESIFTask2_2_bd_pwmBlock_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ESIFTask2_2_bd_pwmBlock_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ESIFTask2_2_bd_pwmBlock_0_0.tcl
