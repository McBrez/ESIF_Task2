...
################################################################
# This is a generated script based on design: ESIFTask2_2_bd
#
...
# source ESIFTask2_2_bd_script.tcl
...
set design_name ESIFTask2_2_bd
...
proc create_root_design { parentCell } {
  ...
  # Create instance: pwmBlock_0, and set properties
  set block_name pwmBlock
  set block_cell_name pwmBlock_0
  if { [catch {set pwmBlock_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $pwmBlock_0 eq "" } {
  ...
  connect_bd_net -net axi_gpio_0_gpio2_io_o [get_bd_pins axi_gpio_0/gpio2_io_o] [get_bd_pins pwmBlock_0/thresh]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins pwmBlock_0/clk] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net pwmBlock_0_pwmOut [get_bd_ports LEDS] [get_bd_pins pwmBlock_0/pwmOut]
