...
HD_PWD='D:/DEV/Embedded Systems in FPGAs/Task2/ESIF_Task2/Subtask1/ESIFTask2_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ESIFTask2_1_bd_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ESIFTask2_1_bd_wrapper.tcl
