...
set_property IOSTANDARD LVCMOS33 [get_ports dBtnU]
set_property PACKAGE_PIN T18 [get_ports dBtnU]
set_property IOSTANDARD LVCMOS33 [get_ports dBTnD]
set_property PACKAGE_PIN R16 [get_ports dBTnD]
set_property DRIVE 12 [get_ports {PS_GPIO[22]}]

set_property PACKAGE_PIN Y13 [get_ports {PS_GPIO[21]}]
set_property PACKAGE_PIN AA12 [get_ports {PS_GPIO[6]}]
set_property PACKAGE_PIN AB12 [get_ports {PS_GPIO[5]}]
set_property PACKAGE_PIN U10 [get_ports {PS_GPIO[4]}]
set_property PACKAGE_PIN U9 [get_ports {PS_GPIO[3]}]
set_property PACKAGE_PIN U11 [get_ports {PS_GPIO[2]}]
set_property PACKAGE_PIN U12 [get_ports {PS_GPIO[1]}]

set_property IOSTANDARD LVCMOS33 [get_ports DBTND]
set_property IOSTANDARD LVCMOS33 [get_ports DBTNU]
set_property PACKAGE_PIN T18 [get_ports DBTNU]
set_property PACKAGE_PIN R16 [get_ports DBTND]
set_property PACKAGE_PIN R15 [get_ports {PS_GPIO[22]}]
