...
HD_PWD='D:/DEV/ESIF/Task2/ESIF_Task2/Subtask4/xillinux-eval-zedboard-2.0c/vhdl/vivado/xillydemo.runs/top_oled_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_oled_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_oled_0.tcl
