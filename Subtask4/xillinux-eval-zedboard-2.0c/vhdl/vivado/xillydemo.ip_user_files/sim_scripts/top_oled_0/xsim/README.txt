...
#
# Generated by export_simulation on Thu Jun 20 17:06:09 +0200 2019
#
################################################################################
...
'-reset_run' switch to the './top_oled_0.sh' script.

./top_oled_0.sh -reset_run
...
./top_oled_0.sh -noclean_files

For more information on the script, please type './top_oled_0.sh -help'.
